...
<div class="d-flex justify-content-between align-items-center mb-4">
  <div>
    <h2 class="mb-0 fw-bold"><i class="bi bi-box-arrow-up text-danger me-2"></i>Other Expenses Log</h2>
    <p class="text-muted small mb-0">Record unplanned/miscellaneous expenses. Amounts pull automatically into the Tracker for <?= h($selectedMonth) ?> <?= $selectedYear ?>.</p>
  </div>
  <div>
    <a href="csv_export.php?type=other_expenses&year=<?= $selectedYear ?>&month=<?= h($selectedMonth) ?>" class="btn btn-sm btn-outline-success">
  ...
  <form method="get" class="row g-2 align-items-center">
    ...
    <div class="col-md-5">
      <div class="input-group input-group-sm">
        ...
        <input type="text" name="search" class="form-control" placeholder="Search description or notes..." value="<?= h($filterSearch ?? '') ?>">
      </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-2 d-flex gap-2">
      ...
      <a href="other_expenses.php" class="btn btn-sm btn-outline-secondary">Reset</a>
    </div>
  </form>
</div>
...
<div class="row g-4">
          ...
          <tbody>
            <?php foreach ($paginatedLogs as $log): ?>
              <tr>
                ...
                <td class="text-end fw-bold text-danger">-<?= fmt_money($log['amount'], $symbol) ?></td>
                <td class="text-end">
            ...
            <?php if (empty($paginatedLogs)): ?>
              <tr><td colspan="4" class="text-center text-muted py-4">No other expense entries recorded.</td></tr>
            <?php endif; ?>
          </tbody>
        </table>
      </div>
  ...
  <div class="col-lg-5">
    <div class="card p-3 shadow-sm">
      <h5 class="fw-bold mb-3"><i class="bi bi-plus-circle me-2"></i>Add Other Expense</h5>
      <form method="post">
        <?= csrf_field() ?>
        ...
        <div class="mb-2">
          ...
          <input type="text" name="description" class="form-control form-control-sm" required placeholder="e.g. Car battery fix">
        </div>
        <div class="mb-3">
